...
function isPrimeNumber(num) {
 ...
 // Якщо num не ділиться націло ні на одне зі значень i, то num є простим, тому повертаємо true  
  return true;
  }
}
...
// Задача 5: Напишіть функцію, яка перевіряє, чи є заданий рядок пустим. 
//Використовуйте умовний оператор та властивість довжини рядка для перевірки.
...
// що відповідає типу цієї змінної. Використовуйте тернарний оператор для визначення типу змінної.
...
function getVariableType(variable) {
  ...
  switch (typeof variable) {
    ...
    case "string":
      ...
      break;
    case "boolean":
      type = "Це булеве значення";
      break;
    default:
      type = "Це інший тип";
  }
  return type;
  // Використовуємо оператор switch для знаходження типу змінної
  // В кожному випадку (case) перевіряємо тип змінної і присвоюємо змінній type відповідний рядок
  // Якщо тип змінної number, то type = "Це число"
  // Якщо тип змінної string, то type = "Це рядок"
  // Якщо тип змінної boolean, то type = "Це булеве значення"
  // Якщо тип змінної не співпадає з жодним з випадків, то type = "Це інший тип"
  // Повертаємо тип змінної, який зберегли у змінній type
...
// Задача 15: Створити мемоізовану версію функції, яка обчислює площу квадрата на основі довжини його
// сторони.

function memoizedArea() {
  // Ініціалізуємо примітивні змінні для зберігання попереднього аргументу та результату
  let beforeArgument = null;
  let result = null;
...
// Задача 17: створити дві функції, одна з яких збільшує число на 1, а інша - множить число на 2,
//а потім створити композицію цих функцій.
